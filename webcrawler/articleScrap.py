...
class GenericSpider(Spider):
    ...
    def parse(self,response):
        ...
        elif (self.domain == "washingtonpost.com"):
            articles = Selector(response).xpath('//div[@class="pb-feed-headline ng-scope"]/p')
        elif (self.domain == "reuters.com"):
            articles = Selector(response).xpath('//div[@class="search-result-content"]/h3[@class="search-result-title"]')
